...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO profesor (PRnombre, PRapellido, lsttipo, Correo, PRciudad, PRpais, PRfechadia, PRfechames, PRfechanano, Imagen, NivelEnsenanza, PRemergencia, Cedula, Telefono, Activo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['NiveldeEnsenanza'], "int"),
  ...
  $insertGoTo = "TabladeProfesor.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<option value="Zimbabue ">Zimbabue </option>
  ...
  <p align="center">Nivel de Ensenanza:</p>
  <p align="center">
    <label for="NiveldeEnsenanza">NiveldeEnsenanza</label>
    <select name="NiveldeEnsenanza" id="NiveldeEnsenanza">
