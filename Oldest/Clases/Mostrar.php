...
function emergente(url){
	...
	window.open(url,'clases', 'top=' +top + 'left=' + left + 'toolbar=no,scrollbars=yes,width=450,height=350')
	}
</script>
</head>
<body>
...
<table class="table" width="80%">
  ...
  <tbody>  <tr>
      ...
      <td><a href="#" onclick="javascript:emergente('clases.php?idClases=<?php echo $row_ClasesID["idClases"];?>') ">Editar</a></td>
    </tr>
