...
$query="SELECT `idEstudiantes` FROM `estudiantes` WHERE  '".$_GET["idEstudiantes"]."=".$eliminar."'";
...
if(mysql_num_rows($result) > 0){
	$query="DELETE FROM `estudiantes` WHERE `idEstudiantes` ='".$_GET["idEstudiantes"]."=".$eliminar."'";
	$result=mysql_query($query,$con) or die("Error: ".mysql_error());
