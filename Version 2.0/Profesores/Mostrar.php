...
function emergente(url){
	...
	window.open(url,'profesor', 'top=' +top + 'left=' + left + 'toolbar=no,scrollbars=yes,width=450,height=350')
	}
</script>
</head>
 ...
 <thead>
  ...
  <?php do { ?>
    <tr>
      ...
      <td> <a href="#" onclick="javascript:emergente('profesor.php?idProfesores=<?php echo $row_Profesor["idProfesores"];?>') "><img src="data:image/jpeg;base64,<?php echo base64_encode($row_Profesor['FotoProf']); ?>" width="64px" height="50px" /></a></td>
