...
<h1 align="center">&nbsp;</h1>
<h1 align="center">Registro de Profesor</h1>
...
<option value="Zimbabue ">Zimbabue </option>
  ...
  <p align="center">
    <label for="textfield"></label>
    <input type="text" name="TCelular" id="TCelular" />
  </p>
  <p align="center">Cedula:<br />
...
while($row = mysql_fetch_array($ListOptions))
{
  ...
  <p align="center">Turno:<br />
  </p>
  <p align="center"><select name="TxTurno" id="TxTurno" >
    <?php
...
$query = "SELECT * FROM turno ORDER BY idTurno";
...
while($row = mysql_fetch_array($ListOptions))
{
  ...
  <p align="center">
    ...
    <br>
    <input type= "submit" name ="submit" value ="Subir Profesor"></p></form>
...
{
	mysql_connect("mysql13.000webhost.com","a1928538_dbschl","1521aHg")or die("No se puede conectar a la base de deatos");
	mysql_select_db("a1928538_dbschl") or die("No se puede conectar a la base de deatos");
...
{
  mysql_query("INSERT INTO profesores(profesores_nombres,Profesores_apellidos,Sexo,telefono,celular,Cedula,direccion,Nacionalidad,Ciudad,correo,IDDepartamento,Salario,Dinero,FotoProf,ProfDia,ProfMes,ProfAnio,id_Turno) VALUES ('$txnombres','$txapellidos','$sexo','$Telefono','$celular','$cedula','$direccion','$pais','$ciudad','$correo','$Depart','$Salario','$Dinero','$imageData','$dia','$mes','$ano','$Turno')");
  
   echo "Codigo Funcionando" ;

  $insertGoTo = "/Profesores/Mostrar.php";
