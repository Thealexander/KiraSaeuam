...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO edificios (Codigo_edificio, descripcion) VALUES ( %s, %s)",
                       GetSQLValueString($_POST['Codigo_edificio'], "text"),
...
<title>Registros de Infraestructura</title>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table class="table" 	align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Codigo edificio:</td>
      <td><input type="text" name="Codigo_edificio" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" value="Registrar Edificio" /></td>
    </tr>
  </table>
